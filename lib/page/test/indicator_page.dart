...
class _IndicatorState extends State<_IndicatorView> {
  ...
  Widget build(BuildContext context) {
    ...
    double deviceWidth = ScreenUtils.getDeviceWidth(context);
    double offSetX = deviceWidth * 0.1 +
        (deviceWidth - radius * 2 - deviceWidth * 0.2) * offsetPercent / 4;
        ...
        Transform.translate(
          ...
          child: CustomPaint(
            painter: BesselViewPainter(
                ...
                isToRight: isToRight,
                color: HSVColor.lerp(
                        HSVColor.fromColor(colors[preInteger > curPosition
                            ? curPosition.toInt()
                            : preInteger]),
                        HSVColor.fromColor(colors[preInteger > curPosition
                            ? preInteger
